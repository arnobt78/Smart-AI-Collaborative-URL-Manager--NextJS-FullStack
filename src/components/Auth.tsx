        ...
        >
          ...
          >
            ...
            <form className={FORM_STACK} onSubmit={handleSignIn}>
              {/* Guest Select — Radix DropdownMenu (modal={false}; match trigger width) */}
              <div className="auth-reveal auth-reveal-delay-1 relative space-y-1.5">
                <label
                  htmlFor="auth-guest"
                ...
                >
                  <DropdownMenuTrigger asChild>
                    <button
                      ...
                      className={`${UI_FORM_CONTROL} flex items-center justify-between gap-2 text-left focus:outline-none focus:ring-0 ${UI_GLASS_MENU_TRIGGER_FOCUS}`}
                    >
              ...
              <div className="auth-reveal auth-reveal-delay-4 space-y-3 sm:space-y-4 pt-4 sm:pt-6">
                ...
                <div className="flex flex-wrap items-center justify-center gap-x-2 gap-y-1 text-sm text-gray-300">
                  ...
                  <button
                    ...
                    disabled={loading}
                    className="font-medium text-[#00ff99] hover: disabled:opacity-50 disabled:cursor-not-allowed inline-flex items-center gap-1.5"
                  >
