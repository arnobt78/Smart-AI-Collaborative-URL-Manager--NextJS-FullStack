...
export function ListDetailHeaderChrome({
  ...
  return (
    ...
    >
      <div className={cn(HEADING_STACK, "gap-2 min-w-0")}>
          ...
          <div className="flex items-center gap-2 shrink-0">
            {onBack ? (
              <button
                ...
                className={cn(
                  UI_CONTROL_HEIGHT,
                  "inline-flex shrink-0 items-center justify-center gap-1 rounded-lg border border-white/15 bg-white/5 px-2.5 text-xs text-white/80 hover:bg-white/10 hover:text-white transition-colors",
                )}
                aria-label="Back"
              >
