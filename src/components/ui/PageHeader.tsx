  ...
  return (
    <header className={cn("flex items-center gap-3", className)}>
      ...
      <div className="min-w-0">
        <h1 className="text-2xl font-medium leading-tight text-white sm:text-3xl">{title}</h1>
        <p className="text-sm leading-snug text-white/60 sm:text-base">{description}</p>
      </div>
    </header>
  );
}
