...
const PRIMARY_LAYOUT =
  "h-11 inline-flex items-center justify-center gap-2 rounded-xl backdrop-blur-md transition duration-200 !text-white font-medium";
...
export const GLASS_GHOST_BUTTON =
  "h-11 inline-flex items-center justify-center gap-2 rounded-xl border border-white/10 bg-white/5 backdrop-blur-md shadow-[0_15px_35px_rgba(0,0,0,0.3)] transition duration-200 hover:bg-white/10 hover:border-white/20 hover:shadow-[0_20px_45px_rgba(0,0,0,0.5)] text-white/80 hover:text-white disabled:opacity-50 disabled:cursor-not-allowed";
