...
| RISK-0016 | `npm audit` reports three high Prisma CLI transitive findings in `deepmerge-ts@7.1.5` | High | Known | Prisma 6.19.3 has no compatible patched release; npm's forced fix downgrades Prisma. Do not apply an unsafe forced change; reassess with a Prisma-supported upgrade plan. | dependency baseline |
