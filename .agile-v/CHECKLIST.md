...
- [x] REQ-0047 / TASK-0052 logout await signout (local validation pass; superseded by REQ-0048)
- [x] REQ-0048 / TASK-0053 C7.7 optimistic logout (local validation pass)
