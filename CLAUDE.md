...
## Status (C1)
Done: AI/guardrails/SafeImage/observability/deps/SEO · Auth UI · flash/navbar/Select · welcome/goodbye toasts · Sparkles CTA · `scrollbar-gutter: stable`.  
Human: HA-0001; Sentry org/token.  
...
## Auth / layout
`wasAuthed` HomePage gate · static Navbar · `auth-toast` + `AuthToastBridge` · html gutter stable · Auth `inset-0`
