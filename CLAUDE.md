...
Done: C7.8–C7.21 · **LLM** `c085f69` REQ-AI-0001 · **Icons** CONTROL/DECORATIVE · **C7.18** SSE `eventKey` dedup.
...
Human: HA-0001; GATE-0038 closed; parked next: Add URL `https://` 400, archive-url 400, UrlCard empty on fast scroll (after deploy re-smoke).
Validate: Jest · lint 0 · tsc · build · e2e C7.21 · audit 0. · Resume: `.agile-v/STATE.md`.
