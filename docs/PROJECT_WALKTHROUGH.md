...
- Open later: optional `(auth)` route-group; lists/browse cold API slim; status API speed OOS; latency; virtualization; Cloudinary destroy.
...
- Manual: TASK-0039 Network intake DONE; C7.21–C7.23 local verified — prod re-smoke after deploy.
- Audit: lint/tsc/Jest/build/e2e C7.23 pass; RISK-0016 closed (deepmerge override); Gate 2 needs EvalGate.
