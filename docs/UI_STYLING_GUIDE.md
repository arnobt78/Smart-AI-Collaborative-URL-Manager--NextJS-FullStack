...
>
  <div class="flex items-start justify-between gap-4">
    <div>
      ...
      <p class="mt-3 text-lg sm:text-xl font-semibold text-white">Value</p>
    </div>
  </div>
...
>
  <div class="flex items-start justify-between gap-4">
    <div>
      ...
      <p class="mt-3 text-lg sm:text-xl font-semibold text-white">150</p>
    </div>
  </div>
...
>
  <div class="flex items-start justify-between gap-4">
    <div>
      ...
      <p class="mt-3 text-lg sm:text-xl font-semibold text-white">42</p>
    </div>
  </div>
  <p class="mt-4 text-sm text-white/70">
...
>
  <div class="flex items-start justify-between gap-4">
    <div>
      ...
      <p class="mt-3 text-lg sm:text-xl font-semibold text-white">89</p>
    </div>
  </div>
  <p class="mt-4 text-sm text-white/70">
